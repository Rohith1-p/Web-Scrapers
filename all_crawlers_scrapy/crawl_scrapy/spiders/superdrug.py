...
class SuperdrugSpider(SetuservSpider):
    name = 'superdrug-product-reviews'

    def __init__(self, mongo_host, mongo_port, mongo_db, mongo_collection, document_id, env):
        super().__init__(mongo_host, mongo_port, mongo_db, mongo_collection, document_id, self.name, env)
        self.logger.info("Superdrug process start")
        assert self.source == 'superdrug'
        ...
        if res['BatchedResults']['q0']['Results']:
            for item in res['BatchedResults']['q0']['Results']:
                if item:
                    ...
                    _id = item["Id"]
                    review_date = \
                        datetime.datetime.strptime((item.get('SubmissionTime').split('+')[0]),
                                                   "%Y-%m-%dT%H:%M:%S.%f")
    ...
    def get_review_url(product_id, limit, offset):
        url = "https://api.bazaarvoice.com/data/batch.json?passkey=i5l22ijc8h1i27z39g9iltwo3" \
              "&apiversion=5.5&displaycode=10798-en_gb&resource.q0=reviews&filter." \
              "q0=isratingsonly%3Aeq%3Afalse&filter.q0=productid%3Aeq%3A{}&filter." \
              "q0=contentlocale%3Aeq%3Aen_GB%2Cen_US&sort.q0=submissiontime%3Adesc&stats" \
              ".q0=reviews&filteredstats.q0=reviews&include.q0=authors%2Cproducts%2Ccomments" \
              "&filter_reviews.q0=contentlocale%3Aeq%3Aen_GB%2Cen_US&filter_reviewcomments" \
              ".q0=contentlocale%3Aeq%3Aen_GB%2Cen_US&filter_comments" \
              ".q0=contentlocale%3Aeq%3Aen_GB%2Cen_US&limit.q0={}&offset.q0={}" \
              .format(product_id, limit, offset)
        return url
