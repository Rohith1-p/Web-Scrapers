...
class VitacostSpider(SetuservSpider):
    name = 'vitacost-product-reviews'

    def __init__(self, mongo_host, mongo_port, mongo_db, mongo_collection, document_id, env):
        super().__init__(mongo_host, mongo_port, mongo_db, mongo_collection, document_id, self.name, env)
        self.logger.info("Vitacost process start")
        assert self.source == 'vitacost'
    ...
    def parse_reviews(self, response):
        ...
        res = res['BatchedResults']['q0']['Results']
    ...
    def get_review_url(product_id, limit, offset):
        url = "https://api.bazaarvoice.com/data/batch.json?passkey=pgtdnhg3w0npen2to8bo3bbqn" \
              "&apiversion=5.5&displaycode=4595-en_us&resource.q0=reviews&filter." \
              "q0=isratingsonly%3Aeq%3Afalse&filter.q0=productid%3Aeq%3A{}&filter." \
              "q0=contentlocale%3Aeq%3Aen_US&sort.q0=submissiontime%3Adesc&stats" \
              ".q0=reviews&filteredstats.q0=reviews&include.q0=authors%2Cproducts" \
              "%2Ccomments&filter_reviews.q0=contentlocale%3Aeq%3Aen_US&filter_" \
              "reviewcomments.q0=contentlocale%3Aeq%3Aen_US&filter_comments." \
              "q0=contentlocale%3Aeq%3Aen_US&limit.q0={}&offset.q0={}" \
