...
class DeletePeapod(Test):
    def test_delete(self):
        self.mongo_collection.delete_many({"media_entity_id": product_id})


class TestPeapod(Test):
    filter = {'media_source': media_source, 'media_entity_id': product_id}
    ...
    def test_body(self):
        ...
        except: print("Check the body of review with id {}".format(i['creator_id']))
