...
class RossmannSpider(SetuservSpider):
    name = 'rossmann-product-reviews'

    def __init__(self, mongo_host, mongo_port, mongo_db, mongo_collection, document_id, env):
        super().__init__(mongo_host, mongo_port, mongo_db, mongo_collection, document_id, self.name, env)
        self.logger.info("Rossmann process start")
        assert self.source == 'rossmann'
    ...
    def get_review_url(product_id, limit, offset):
        url = f"https://api.bazaarvoice.com/data/batch.json?" \
              f"passkey=caHfvcPRYV9oKTaSfX8gEDoqZe7c3NrSzetfhtKbzYQiw&apiversion=5.5" \
              f"&displaycode=16671-de_de&resource.q0=reviews&filter.q0=isratingsonly" \
              f"%3Aeq%3Afalse&filter.q0=productid%3Aeq%3A{product_id}&filter." \
              f"q0=contentlocale%3Aeq%3Ade_DE&sort.q0=submissiontime%3Adesc&stats" \
              f".q0=reviews&filteredstats.q0=reviews&include.q0=authors%2Cproducts" \
              f"%2Ccomments&filter_reviews.q0=contentlocale%3Aeq%3Ade_DE&filter_" \
              f"reviewcomments.q0=contentlocale%3Aeq%3Ade_DE&filter_comments." \
              f"q0=contentlocale%3Aeq%3Ade_DE&limit.q0={limit}&offset." \
